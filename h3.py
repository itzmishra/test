...
csv_file = "new_healthy_test3_waveform.csv"
...
df.to_csv("new_healthy_engine3_features.csv", index=False)

print("\nSaved feature table as engine_features.csv")


# ---------- Save Bispectrum Data (NEW) ----------
bispectrum_file = "new_healthy_test3_bispectrum.csv"
...
bispectrum_features_file = "new_healthy_test3_bispectrum_features.csv"
