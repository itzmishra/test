...
df.to_csv("map1_engine_features.csv", index=False)

print("\nSaved feature table as engine_features.csv")


# ---------- Save Bispectrum Data (NEW) ----------
bispectrum_file = "map1_test_bispectrum.csv"
...
bispectrum_features_file = "map1_test_bispectrum_features.csv"
