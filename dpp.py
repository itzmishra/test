...
def plot_mfcc_heatmap(y, sr, n_mfcc=13, n_fft=2048, hop_length=512, title="MFCC Heatmap"):
...
# Plot standard MFCC heatmap
mfccs = plot_mfcc_heatmap(denoised_signal, sr, title="MFCC Heatmap (Denoised Audio)")
...
for n_mfcc in n_mfcc_list:
    for win_sec in window_lengths:
        ...
        librosa.display.specshow(mfcc, sr=sr, hop_length=hop_len, x_axis="time", cmap='coolwarm')
        plt.xlabel("Time (s)")
