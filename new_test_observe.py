...
csv_file = "new_healthy_test1_waveform.csv"
...
df.to_csv("new_healthy_engine1_features.csv", index=False)

print("\nSaved feature table as engine_features.csv")


# ---------- Save Bispectrum Data (NEW) ----------
bispectrum_file = "new_healthy_test1_bispectrum.csv"
...
bispectrum_features_file = "new_healthy_test1_bispectrum_features.csv"
